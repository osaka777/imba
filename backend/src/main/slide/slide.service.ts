  ...
  async createSlide(dto: CreateSlideDto) {
    return this.prisma.slide.create({
      data: {
        ...
        layoutMode: dto.layoutMode ?? 'classic',
        showSecondaryButton: dto.showSecondaryButton ?? false,
        secondaryButtonText: dto.secondaryButtonText ?? null,
        secondaryButtonLink: dto.secondaryButtonLink ?? null,
        secondaryButtonColor: dto.secondaryButtonColor ?? null,
        secondaryButtonTextColor: dto.secondaryButtonTextColor ?? '#ffffff',
        secondaryButtonOpacity: dto.secondaryButtonOpacity ?? 20,
      },
    });
  }
  ...
  async updateSlide(id: number, dto: UpdateSlideDto) {
    ...
    return this.prisma.slide.update({
      ...
      data: {
        ...
        buttonColor: dto.buttonColor ?? slide.buttonColor,
        buttonTextColor: dto.buttonTextColor ?? slide.buttonTextColor,
        layoutMode: dto.layoutMode ?? slide.layoutMode,
        showSecondaryButton: dto.showSecondaryButton ?? slide.showSecondaryButton,
        secondaryButtonText: dto.secondaryButtonText ?? slide.secondaryButtonText,
        secondaryButtonLink: dto.secondaryButtonLink ?? slide.secondaryButtonLink,
        secondaryButtonColor: dto.secondaryButtonColor ?? slide.secondaryButtonColor,
        secondaryButtonTextColor: dto.secondaryButtonTextColor ?? slide.secondaryButtonTextColor,
        secondaryButtonOpacity: dto.secondaryButtonOpacity ?? slide.secondaryButtonOpacity,
      },
    });
  }

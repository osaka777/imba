...
export function getDefaultPromoModalSettings(): PromoModalSettingsFile {
  return {
    ...
    stepDepositText: 'Пополни счёт от минимальной суммы',
    bonusHighlight: '100 $',
    ctaDeposit: 'Перейти к пополнению',
    ctaClaim: 'Получить бонус',
    ctaGoToWc: 'Смотреть матчи ЧМ',
    successTitle: 'Готово!',
    successSubtitle: 'Бонус активирован — удачных ставок на Чемпионат мира',
    heroImageUrl: '/football2026.png',
    bannerImageUrl: '/football2026.png',
    gradientFrom: '#00c2ff',
    gradientTo: '#0009da',
    accentColor: '#7AFF6E',
    promoCode: 'WC2026',
    promoType: 'DIRECT_BONUS',
    minDepositAmount: 5000,
    minDepositCurrency: 'RUB',
    bonusPercentage: 100,
    bonusAmount: 100,
    bonusCurrency: 'USD',
    promoAvailable: 10000,
    validUntilDays: 90,
    presetAmounts: [5000, 10000, 20000],
    wcRedirectPath: '/wc',
    autoSyncPromo: true,
  };
}

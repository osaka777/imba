...
/** Mirrors backend cybersport-catalog.ts (Olimpbet esports 1039–1087). */
export const CYBERSPORT_CATALOG: CybersportCatalogEntry[] = [
  ...
  { olimpbetId: 1040, apiSport: "esports.cs", pathSlug: "cs2", label: "CS2" },
...
const MOBA_API_SPORTS = new Set([
  "esports.dota2",
  "esports.lol",
  "esports.lol-wild-rift",
...
export function cyberIconForApiSport(apiSport: string): React.FC<{ className?: string }> {
  return MOBA_API_SPORTS.has(apiSport) ? DotaIcon : CSIcon;
}
